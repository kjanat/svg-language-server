...
- `deploy.framework` (required unless `deploy.runtime` is set): The framework
  ...
  [framework integrations docs](https://docs.deno.com/deploy/reference/frameworks/).
...
[Learn more about environment variables](https://docs.deno.com/deploy/reference/env_vars_and_contexts/).
