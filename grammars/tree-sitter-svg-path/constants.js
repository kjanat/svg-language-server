 ...
 * into grammar.js). `grammar.test.ts` asserts this stays equal to the svg-data
 * catalog (crates/svg-data/data/catalog.tree-sitter.json tokens.path_command_letters)
